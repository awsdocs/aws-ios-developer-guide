...
This repository contains source content for the official `AWS SDK for iOS Developer Guide`_. The
source code for the `AWS SDK for iOS`_ is also on GitHub, at https://github.com/aws/aws-sdk-ios.
